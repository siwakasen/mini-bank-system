...
public class LoansDAO {
    ...
    public void insertLoan(Loans loan){
        try {
            ...
            String sql = "INSERT INTO loans (loan_id, loan_type, amount, interest_rate, loan_start_date, loan_end_date, interest_rate_type, end_amount_pay, confirm) VALUES ('"+loan.getLoan_id()+"', '"+loan.getLoantype()+"', '"+loan.getAmount()+"', '"+loan.getInterest_rate()+"', '"+loan.getLoan_start_date()+"', '"+loan.getLoan_end_date()+"', '"+loan.getInterest_rate_type()+"', '"+loan.getEnd_amount_pay()+"', '"+loan.getConfirm()+"')";
