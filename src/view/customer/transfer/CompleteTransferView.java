 ...
 * @author personal7
 */
public class CompleteTransferView extends javax.swing.JFrame {
     ...
     */
    public CompleteTransferView(Accounts account, Transactions transaction, Transfers transfer, String nama) {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompleteTransferView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompleteTransferView(new Accounts(0, "", 0, new Customers(0, "", "", "", "", ""), "", ""), new Transactions("",0,"",""), new Transfers("", 0, 0, 0.0), "").setVisible(true);
            }
        });
    }
