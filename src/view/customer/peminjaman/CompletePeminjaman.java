 ...
 * @author personal7
 */
public class CompletePeminjaman extends javax.swing.JFrame {
     ...
     */
    public CompletePeminjaman(Accounts account, Transactions transaction, Loans loan) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompletePeminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompletePeminjaman(new Accounts(0, "", 0, new Customers(0, "", "", "", "", ""), "", ""), new Transactions("",0,"",""), new Loans("", "", "", "", 0.0, 0, "", 0, "")).setVisible(true);
            }
        });
    }
